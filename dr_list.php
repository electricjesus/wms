...
?>
<center>
	<a href="dr_list.php?force=true"><strong>! FORCE ALL !</strong></a>
...
<table width='710' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr valign='middle'>
    <td width='78' height='24' align='center' valign='top'>
		<strong><a href="dr_list.php?order=1&<?php echo $get_str; ?>">DR Date</a></strong> </td>
    <td width='92' align='center' valign='top'>
		<strong><a href="dr_list.php?order=2&<?php echo $get_str; ?>">DR Number</a></strong> </td>
    <td width='233' align='center' valign='top'>
		<strong><a href="dr_list.php?order=3&<?php echo $get_str; ?>">Transaction Title</a> </strong></td>
    <td width='66' align='center' valign='top'>
		<strong><a href="dr_list.php?order=4&<?php echo $get_str; ?>">Type</a></strong> </td>
    <td width='108' align='center' valign='top'>
		<strong><a href="dr_list.php?order=5&<?php echo $get_str; ?>">Product Line</a> </strong></td>
    <td width='133' align='center' valign='top'>
		<strong><a href="dr_list.php?order=6&<?php echo $get_str; ?>">DR Amount</a></strong> </td>
  </tr>
  <?php 
  $ctr = 0;
